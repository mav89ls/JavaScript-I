...
//will need help understanding this one, specifically why we needed to make an oldOCunt variable and what i was doing wrong before that. The original code i was working on you can see below.
...
console.log("There are a grand total of " + oldCount + " old vehicles on our lot: " + oldCars);


// my original code i worked on but could not get to work. tried using something other than i for the loop, dont know if im using the if statement correctly.
